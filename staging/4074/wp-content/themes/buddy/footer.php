...
<?php if ( !is_page_template( 'blank-page.php' ) ) { ?>
	...
	<div id="copyright">
		...
		<?php } else { ?>
			<?php esc_html_e( 'Copyright &copy;', 'buddy' ); ?> <?php echo date( 'Y' ); ?> <a href="http://code4cause.com"><?php esc_html_e( 'Code4Cause', 'buddy' ); ?></a>. <?php esc_html_e( 'All rights reserved.', 'buddy' ); ?>
		<?php } ?>
	</div>
